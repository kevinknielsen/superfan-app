...
export default function Step2DealTerms({ onNext }: Step2Props) {
  const { dealData, updateField } = useCreateDeal()
  ...
  const handleChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    if (["targetRaise", "minContribution", "maxContribution"].includes(name)) {
      ...
      updateField(name as keyof typeof dealData, numValue)
    } else {
      updateField(name as keyof typeof dealData, value)
    }
  ...
  const validateForm = () => {
    ...
    } else if (dealData.startDate && new Date(dealData.endDate) <= new Date(dealData.startDate)) {
      ...
      <div className="space-y-4">
        <div>
          ...
          <Input
            ...
            value={dealData.targetRaise === null ? "" : dealData.targetRaise}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <Input
              ...
              step="10"
              placeholder="e.g., 100"
              value={dealData.minContribution === null ? "" : dealData.minContribution}
              onChange={handleChange}
          ...
          <div>
            ...
            <Input
              ...
              value={dealData.maxContribution === null ? "" : dealData.maxContribution}
              onChange={handleChange}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <Input
              ...
              min={dealData.startDate || new Date().toISOString().split("T")[0]}
            />
